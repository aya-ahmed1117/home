...
////////////////
  ...
  $Absen_query = sqlsrv_query( $con ,"exec Absenteeism_Dashboard_manager @id = '$self'");
...
and username in
( select username from employee_web_table where manager ='$self')  and psd_number is null
group by
year([schedule_date])
...
( select username from employee_web_table where manager ='$self')   and psd_number is not null
